...
function _objectWithoutPropertiesLoose(e, t) {
  if (null == e) return {};
  for (var o, r = {}, n = Object.keys(e), a = 0; a < n.length; a++)
    (o = n[a]), 0 <= t.indexOf(o) || (r[o] = e[o]);
  return r;
}
function _typeof(e) {
  return (_typeof =
...
var breakpoints = { xs: 0, sm: 576, md: 768, lg: 992, xl: 1200, xxl: 1540 },
  ...
  countupInit = function () {
    window.countUp &&
      document.querySelectorAll("[data-countup]").forEach(function (e) {
        var t,
          o = utils.getData(e, "countup"),
          r = o.autoIncreasing,
          o = _objectWithoutProperties(o, _excluded),
          n = o.endValue,
          a = new window.countUp.CountUp(
            e,
            n,
            _objectSpread({ duration: 5, enableScrollOnce: !0 }, o)
          );
        !a.error && r
          ? (a.update(n),
  ...
  navbarInit = function () {
    var t,
      e,
      o = document.querySelector("[data-navbar-soft-on-scroll]");
    o &&
      ((t = window.innerHeight),
      (e = function () {
        var e = (window.scrollY / t) * 2;
        o.style.backgroundColor = "rgba(49, 60, 89, ".concat(
          (e = 1 <= e ? 1 : e),
          ")"
        );
      })(),
      ...
      document
        ...
        .addEventListener("click", function (e) {
          var t;
          e.target.closest("li") &&
            ((e = document.querySelector("[data-bs-toggle]")),
            (t = document.querySelector("[data-navbar-collapse]")),
  ...
  scrollToTopInit = function () {
    var e = document.querySelector("[data-scroll-top]");
    e &&
  ...
  swiperInit = function () {
    window.Swiper &&
      document.querySelectorAll("[data-swiper]").forEach(function (e) {
        var t = utils.getData(e, "swiper"),
          o = new window.Swiper(e, _objectSpread({}, t)),
          e = document.querySelector(".navbar-vertical-toggle");
        e &&
  ...
  videoControllerInit = function () {
    var e = document.querySelectorAll("[data-video-player-container]");
    e &&
      e.forEach(function (e) {
        function t() {
          e.classList.toggle("video-player-play"),
            e.classList.toggle("video-player-paused");
        }
        var o = e.querySelector("[data-video-player"),
          r = e.querySelector("[data-play-button]");
